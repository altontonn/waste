  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8">
      <div className="grid lg:grid-cols-3 sm:grid-cols-1 md:grid-cols-2 gap-6">
        {skips.map((skip) => (
          <div
            className="border-2 border-lightgray rounded-2xl overflow-hidden shadow-lg bg-darkgray p-8 hover:shadow-2xl transition-shadow duration-300 hover:border-brandblue"
            key={skip.id}>
